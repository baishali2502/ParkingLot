...
//   }
   ...
   public void testEvenDistribution() {
	// Create three parking lots and a parking attendant
	    ...
	    // Assert
	    assertEquals("Lot A should have 1 parked car", 0, lotAsize);
	    assertEquals("Lot B should have 1 parked car", 0, lotBsize);
	    assertEquals("Lot C should have 1 parked car", 0, lotCsize);
